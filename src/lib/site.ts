...
export const siteConfig = {
  ...
  whyChoose: {
    title: 'Why choose Crilio Scents?',
    body: 'Crilio Scents is built for fragrance lovers who want to explore without committing to a full bottle. Every decant is carefully filled, sealed, and labeled so you can sample premium perfume oils with confidence. We focus on authenticity, lasting wear, and a smooth COD checkout experience.',
  },
  testimonials: [
    {
      name: 'Ayesha R.',
